...
import com.crm.ObjectRepository.CreatCampaignPage;
...
public class CreateCampaign {
	...
	public static void main(String[] args) throws Throwable {
		...
		HomePage campaign = new HomePage(driver);
	    campaign.clickMoreLink();
	    campaign.clickCampaignLink();
	    
	    CreatCampaignPage cp = new CreatCampaignPage();
	    cp.campaign();
	}
}	
